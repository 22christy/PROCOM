...
System.out.println();
	...
	String pakaian[] = new String [banyak];
	String ukuran[]= new String [banyak];
	String bhn[] = new String[banyak];
	String pilihan = null, bahan = null;
	int harga[]= new int [banyak];
	int subtotal[] = new int [banyak];
	
	for (int i=0; i < banyak; i++) {
		System.out.printf("Data Pakaian ke - %d ", i+1);
		System.out.println();
		
		System.out.print("Masukkan Pilihan Pakaian <KM / KS/ JT / JS> = ");
		pilihan = br.readLine();
		
		System.out.print("Masukkan Bahan Pakaian <C / J / S / W> = ");
		bahan = br.readLine();
		...
		if (bahan.equalsIgnoreCase("C")) {
			bhn[i] = "Cotton";
		}else if (bahan.equalsIgnoreCase("J")) {
			bhn[i] = "Jeans";
		}else if (bahan.equalsIgnoreCase("S")) {
			bhn[i] = "Spandek";
		}else if (bahan.equalsIgnoreCase("W")) {
			bhn[i] = "Wol";
		}
		
		System.out.println("Pilihan Pakaian = " + pakaian[i]);
		System.out.println("Bahan Pakaian = " + bhn[i]);
	...
	System.out.println("======================================================================");
		for (int i=0; i < banyak; i++) {
			System.out.printf("%d \t%s \t\t %s \t%s \t\t %d", i+1, pakaian[i], bhn[i], ukuran[i], subtotal[i]);
			System.out.println();
